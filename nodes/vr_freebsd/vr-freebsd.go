...
func (n *vrFreeBSD) Init(cfg *clabtypes.NodeConfig, opts ...clabnodes.NodeOption) error {
	// Init VRNode
...
func (n *vrFreeBSD) PreDeploy(_ context.Context, params *clabnodes.PreDeployParams) error {
